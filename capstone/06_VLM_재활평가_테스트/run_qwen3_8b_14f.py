"""[코드 2/8] Qwen3-VL-8B-Instruct 모델 - 14프레임 정규화 추출 평가 실행 스크립트"""
...
def main():
    ...
    print("=" * 68)
    print("   [2/8] Qwen3-VL-8B-Instruct : 14프레임 정규화(14-Frame) 평가")
    print("=" * 68)

    runner = UnifiedVLMRehabRunner(model_type="qwen3_8b", quantization="4bit")
    res = runner.run_rehab_evaluation(video_path, mode="14frames")

    output_report = "result_qwen3_8b_14frames.md"
